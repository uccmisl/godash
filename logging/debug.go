...
func PrintLog(segNum string, arrTime string, delTime string, stallDur string,
	...
	if printLog {
		...
		if extendPrintLog {
			...
			checkInputHeader(printHeadersData, rttHeader, &extendPrintString, twelveString, &rtt, rttIn)
			...
			checkInputHeader(printHeadersData, ttfbHeader, &extendPrintString, twelveString, &ttfb, ttfbIn)
			checkInputHeader(printHeadersData, ttlbHeader, &extendPrintString, twelveString, &ttlb, ttlbIn)
